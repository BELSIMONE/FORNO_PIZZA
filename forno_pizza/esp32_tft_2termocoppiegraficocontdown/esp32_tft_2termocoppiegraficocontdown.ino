...
//#define TFT_MISO 19
#define TFT_MOSI 23 //mio 25  23 o 13
#define TFT_SCLK 18 //mio 26  18 o 14
#define TFT_CS   27 //mio 27  15      Chip select control pin
#define TFT_DC   5 //mio 32  5  o 15 Data Command control pin
...
const int buttonPin = 35;  // Pin del pulsante
const int ledPin = 4;     // Pin del LED interno
unsigned long lastButtonPress = 0;
int countdown = 0;
bool countingDown = false;
bool lastButtonState = HIGH;  // Stato iniziale alto (non premuto)
const unsigned long debounceDelay = 250;  // Tempo di debounce in millisecondi
...
int buttonState = digitalRead(buttonPin);
 currentMillis = millis();
      ...
      if (!countingDown && buttonState == HIGH && countdown > 0 && currentMillis - lastButtonPress >= 3000) {
